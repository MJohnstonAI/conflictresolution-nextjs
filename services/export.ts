...
export const exportService = {
    ...
    downloadMarkdown: (activeCase: Case, rounds: Round[]) => {
        ...
        md += `\n*Generated by Conflict Resolution*`;
        ...
        const content = `
            ...
            <body>
                <div class="container">
                    ...
                    <div class="footer">Generated by Conflict Resolution — Strictly Confidential</div>
                </div>
            </body>
            </html>
        `;
    ...
    printLedgerToPDF: (payload: LedgerPrintPayload) => {
        ...
        const content = `
            ...
            <body>
                ...
                <div class="footer">Generated by Conflict Resolution - Ledger Copy</div>
            </body>
            </html>
        `;
