...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-cyan-500 to-cyan-400 text-slate-950 shadow-lg shadow-cyan-500/30 hover:scale-[1.01] hover:from-cyan-400 hover:to-cyan-300",
        secondary:
          "bg-slate-900 text-slate-100 border border-white/10 hover:border-cyan-400/50 hover:text-white",
        outline:
          "border border-white/10 bg-transparent text-slate-100 hover:border-cyan-400/50",
        ghost:
