...
const CaseSetupModal: React.FC<CaseSetupModalProps> = ({ onClose, onConfirm, opponent }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-navy-950/80 backdrop-blur-md animate-fade-in">
      ...
      <div className="bg-navy-900 border border-navy-800 rounded-2xl w-full max-w-4xl shadow-2xl overflow-hidden flex flex-col md:flex-row max-h-[90vh] md:max-h-auto relative mt-8 md:mt-0">
...
const Home: React.FC = () => {
  ...
  const isAnalyzeDisabled = !text.trim() || (opponent === "Other" && !customAdversary.trim());
